...
CROSS_LAYER_EDGES: tuple[dict[str, str], ...] = (
    ...
    {"rel": "CAN_ESCAPE_TO", "meaning": "Workload/compute escapes to host or steals bound identity (mechanism-labeled, e.g. privileged/SYS_PTRACE/docker.sock/imds)"},
    ...
    {
        "rel": "BRIDGES_TO",
        "meaning": "Unlabeled account-boundary hop into grafted/peer-account resources",
    },
)
