...
AWS_ACTION_MAP: list[tuple[re.Pattern[str], CapabilityType, str | None]] = [
    ...
    (re.compile(r"^ec2:\*"), CapabilityType.CONTROLS, "EC2Instance"),
    ...
    (re.compile(r"^iam:CreateUser|^iam:AttachUserPolicy|^iam:PutUserPolicy|^iam:CreateAccessKey"), CapabilityType.CONTROLS, "User"),
    (re.compile(r"^iam:AttachGroupPolicy|^iam:PutGroupPolicy|^iam:AddUserToGroup"), CapabilityType.CONTROLS, "Group"),
    (re.compile(r"^iam:CreatePolicy|^iam:CreatePolicyVersion|^iam:SetDefaultPolicyVersion"), CapabilityType.CONTROLS, "Policy"),
    (re.compile(r"^iam:CreateInstanceProfile|^iam:AddRoleToInstanceProfile"), CapabilityType.CONTROLS, "InstanceProfile"),
    (re.compile(r"^iam:\*"), CapabilityType.CONTROLS, "IAM"),
    (re.compile(r"^iam:AssumeRole"), CapabilityType.EXECUTES, "Role"),
    (re.compile(r"^glue:CreateDevEndpoint|^glue:UpdateDevEndpoint"), CapabilityType.EXECUTES, "GlueDevEndpoint"),
...
GCP_ROLE_MAP: dict[str, tuple[CapabilityType, str | None]] = {
    ...
    "roles/secretmanager.viewer": (CapabilityType.READS, "GCPSecret"),
    "roles/secretmanager.admin": (CapabilityType.CONTROLS, "GCPSecret"),
    "roles/storage.objectViewer": (CapabilityType.READS, "GCSBucket"),
    "roles/storage.legacyObjectReader": (CapabilityType.READS, "GCSBucket"),
    "roles/storage.objectCreator": (CapabilityType.WRITES, "GCSBucket"),
    ...
    "roles/iam.workloadIdentityUser": (CapabilityType.EXECUTES, "ServiceAccount"),
    "roles/iam.serviceAccountTokenCreator": (CapabilityType.EXECUTES, "ServiceAccount"),
    "roles/iam.serviceAccountKeyAdmin": (CapabilityType.CONTROLS, "ServiceAccount"),
    "roles/iam.securityAdmin": (CapabilityType.CONTROLS, "IAM"),
    "roles/cloudfunctions.developer": (CapabilityType.CONTROLS, "CloudFunction"),
    "roles/cloudfunctions.admin": (CapabilityType.CONTROLS, "CloudFunction"),
    "roles/run.developer": (CapabilityType.CONTROLS, "CloudRunService"),
    "roles/run.admin": (CapabilityType.CONTROLS, "CloudRunService"),
    "roles/run.invoker": (CapabilityType.EXECUTES, "CloudRunService"),
    "roles/cloudbuild.builds.builder": (CapabilityType.EXECUTES, "CloudBuild"),
    "roles/cloudbuild.builds.editor": (CapabilityType.CONTROLS, "CloudBuild"),
    "roles/compute.instanceAdmin.v1": (CapabilityType.CONTROLS, "GCEInstance"),
    "roles/deploymentmanager.editor": (CapabilityType.CONTROLS, "DeploymentManager"),
    "roles/viewer": (CapabilityType.READS, None),
...
def gcp_role_to_actions(role: str) -> set[str]:
    ...
    mapping: dict[str, set[str]] = {
        ...
        "roles/iam.workloadIdentityUser": {"gcp:iam.serviceAccounts.getAccessToken"},
        ...
        "roles/run.developer": {"gcp:run.services.create", "gcp:run.services.update"},
        "roles/run.admin": {"gcp:run.services.create", "gcp:run.services.update"},
        "roles/run.invoker": {"gcp:run.routes.invoke"},
        "roles/cloudbuild.builds.builder": {"gcp:cloudbuild.builds.create"},
        "roles/cloudbuild.builds.editor": {"gcp:cloudbuild.builds.create"},
        ...
        "roles/deploymentmanager.editor": {"gcp:deploymentmanager.deployments.create"},
        "roles/owner": {
            "gcp:owner",
            "gcp:resourcemanager.projects.setIamPolicy",
            "gcp:iam.serviceAccounts.setIamPolicy",
