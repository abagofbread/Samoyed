...
PATTERN_TECHNIQUES: dict[str, tuple[str, ...]] = {
    ...
    "gcp-sa-set-iam-policy": ("T1098.003", "T1098"),
    "gcp-sa-actas-create-run": ("T1578.002", "T1098.003"),
    "gcp-sa-actas-create-gce": ("T1578.002", "T1552.005"),
    "gcp-cloud-build-create": ("T1059.009", "T1578.002"),
    "gcp-deployment-manager": ("T1578.002", "T1059.009"),
    "gcp-roles-update": ("T1098.003", "T1098"),
    "gcp-sign-blob-jwt": ("T1550.001", "T1098.001"),
    "gcp-implicit-delegation": ("T1550.001", "T1098.001"),
    "gcp-gce-set-metadata": ("T1578.005", "T1552.005"),
    ...
    "azure-automation-runbook": ("T1059.001", "T1078.004"),
    "azure-website-deploy": ("T1578.005", "T1552.005"),
    "azure-acr-push": ("T1525", "T1195.002"),
    "azure-add-app-secret": ("T1098.001", "T1550.001"),
    "azure-logic-app-contributor": ("T1078.004", "T1059"),
...
ACTION_TECHNIQUES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("gcp:iam.serviceAccountKeys.create", ("T1098.001",)),
    ("gcp:iam.serviceAccounts.getAccessToken", ("T1550.001",)),
    ("gcp:iam.serviceAccounts.setIamPolicy", ("T1098.003",)),
    ("gcp:resourcemanager.projects.setIamPolicy", ("T1098.003",)),
    ("gcp:compute.instances.setMetadata", ("T1578.005",)),
...
RELATIONSHIP_TECHNIQUES: dict[str, tuple[str, ...]] = {
    ...
    "CAN_STEAL_CREDS_FROM": ("T1552.001", "T1550.001", "T1078.004"),
