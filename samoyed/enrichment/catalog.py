...
MATERIAL_KINDS: dict[str, MaterialKindSpec] = {
    ...
    "api_key": MaterialKindSpec(
        kind="api_key",
        display_name="Third-party API key",
        description="SaaS/API key or token (Stripe, SendGrid, Datadog, etc.) in env/config/source.",
        host_rel="HAS_MATERIAL",
        unlock_rel="UNLOCKS",
        extends_blast_to="External API / SaaS",
        requires_target=False,
    ),
    "oauth_token": MaterialKindSpec(
        kind="oauth_token",
        display_name="OAuth token",
        description="OAuth access/refresh token (GitHub, Google, Slack) usable against a SaaS account.",
        host_rel="HAS_MATERIAL",
        unlock_rel="UNLOCKS",
        extends_blast_to="OAuth-scoped SaaS account",
        requires_target=False,
    ),
    "email_credential": MaterialKindSpec(
        kind="email_credential",
        display_name="Email account credentials",
        description="SMTP/IMAP username+password or app password for a mailbox / mail relay.",
        host_rel="HAS_MATERIAL",
        unlock_rel="UNLOCKS",
        extends_blast_to="Email service / mailbox",
        requires_target=False,
    ),
